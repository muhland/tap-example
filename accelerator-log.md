...
```json
{
  "projectName" : "tanzu-java-web-app-test-marco",
  "repositoryPrefix" : "harbor.dieunkrauts.de/tap-wkld"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor.dieunkrauts.d...(truncated)]
